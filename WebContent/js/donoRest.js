 ...
 */
	...
	function validaCnpj(c){
		...
		var idMsg = document.getElementById("msgCnpj");

		if (c.value.trim().length != 14 || isNaN(c.value)) {
			c.value = "";

			idMsg.style.display = "block";
			idMsg.style.color = "red";
			idMsg.innerHTML = "Coloque um cnpj correto de 14 dígitos!";
	...
	function validaNomeRest(c){
	
		var idMsg = document.getElementById("msgRest");
